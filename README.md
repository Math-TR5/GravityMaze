...
**GravityMaze** est un jeu dans lequel le joueur doit guider une bille à travers un labyrinthe en inclinant le plateau à distance.
...
La création de ce jeu a nécessité la conception et la fabrication de plusieurs pièces, ainsi que l’utilisation de matériel mis à disposition par l'**Université Nice Côte d'Azur**.
...
**3. Le labyrinthe :** il est constituée d'un seule pièce. Nous avons utlisé le logiciel *Fusion360* afin de modéliser en 3D cette pièce, que nous avons par la suite imprimé en 3D.
...
**5- Deux batteries** : elles permettent d'alimenter les deux cartes UCA (celle dans la télécommande et celle dans le socle).
...
### 🗓️ Planning
La réalisation des différentes tâches du projet est synthétisée dans le fichier **diagramme_de_Gantt.pdf**.
Le détail de la contribution de chaque membre du groupe figure dans les dossiers individuels portant leur nom au format **NOM_Prénom**.
